...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.' , 'middleware' => ['module:order']], function () {
            ...
            Route::get('generate-invoice-print/{id}', 'OrderController@generate_invoice_print')->name('generate-invoice-print');
        ...
        Route::group(['prefix' => 'message', 'as' => 'message.'], function () {
            ...
            Route::get('list', 'ConversationController@index')->name('list');
            Route::post('save', 'ConversationController@save')->name('save');
