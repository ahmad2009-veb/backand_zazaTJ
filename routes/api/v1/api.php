...
//        Route::post('login', 'CustomerAuthController@login');
        ...
        Route::group(['prefix' => 'delivery-man'], function () {
            ...
            // ✅ OTP-авторизация для Flutter Driver App
            Route::post('send-otp', 'DeliveryManOtpController@sendOtp');
            Route::post('verify-otp', 'DeliveryManOtpController@verifyOtp');
        });

        // ✅ OTP-авторизация для Flutter Customer App
        Route::group(['prefix' => 'customer'], function () {
            Route::post('send-otp',    'CustomerOtpController@sendOtp');
            Route::post('verify-otp',  'CustomerOtpController@verifyOtp');
        });
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::post('order/status', 'DeliverymanController@orderStatus');
        Route::post('update-order-status', 'DeliverymanController@updateOrderStatus');
    ...
    Route::group(['prefix' => 'partner-request'], function () {
        Route::match(['get', 'post'], 'restaurant', 'PartnerRequestController@storeRestaurant');
        Route::match(['get', 'post'], 'b2b',        'PartnerRequestController@storeB2B');
        Route::match(['get', 'post'], 'corporate',  'PartnerRequestController@storeCorporate');
        Route::match(['get', 'post'], 'corporate-packages', 'PartnerRequestController@storeCorporate');
    });
});
