...
class AddOnController extends Controller
{
    public function list(Request $request)
    {
        ...
        $addons = AddOn::withoutGlobalScope(RestaurantScope::class)->withoutGlobalScope('translate')->with('translations')->where('restaurant_id',
            $vendor->restaurants[0]->id)->latest()->get();
    ...
    public function search(Request $request)
    {
        ...
        $addons = AddOn::withoutGlobalScope(RestaurantScope::class)->whereHas('restaurant',
