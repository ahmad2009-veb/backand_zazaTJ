...
class CustomerController extends Controller
{
    public function address_list(Request $request)
    {
        ...
        $addresses = CustomerAddress::where('user_id', $request->user()->id)->latest()->paginate($limit, ['*'], 'page',
            $offset);
    ...
    public function add_new_address(Request $request)
    {
        ...
        return response()->json([
            ...
            'zone_ids' => array_column($zone->toArray(), 'id'),
        ], 200);
    }
    ...
    public function delete_address(Request $request)
    {
        ...
        if (DB::table('customer_addresses')->where([
            'id'      => $request['address_id'],
            'user_id' => $request->user()->id,
        ])->first()) {
            DB::table('customer_addresses')->where([
                'id'      => $request['address_id'],
                'user_id' => $request->user()->id,
            ])->delete();
    ...
    public function remove_account(Request $request)
    {
        ...
        if (Order::where('user_id', $user->id)->whereIn('order_status',
