...
class PaytabsController extends Controller
{
    ...
    {
        $order = Order::with(['details', 'customer'])->where(['id'      => session('order_id'),
        ...
        $data        = [
            ...
            // Nullable - Must be HTTPS, otherwise no post data from paytabs
            "return"           => url('/') . "/paytabs-response",
            // Must be HTTPS, otherwise no post data from paytabs , must be relative to your site URL
            "customer_details" => [
                "name"    => $user->f_name,
                "email"   => $user->email,
                "phone"   => "000000",
