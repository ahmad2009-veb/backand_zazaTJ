...
class RestaurantController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $shop->logo = $request->has('image') ? Helpers::update('restaurant/', $shop->logo, 'png',
            $request->file('image')) : $shop->logo;

        $shop->cover_photo = $request->has('photo') ? Helpers::update('restaurant/cover/', $shop->cover_photo, 'png',
            $request->file('photo')) : $shop->cover_photo;
