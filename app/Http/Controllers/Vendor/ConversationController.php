...
class ConversationController extends Controller
{
    ...
    function index()
    {
        ...
        return view('vendor-views.messages.index', compact('messages'));
    }
    ...
    {   
        ...
        $message->name            = $vendor->f_name.' '.$vendor->l_name;
        $message->role            = $rls;
        $message->message         = $request->reply;
        
        $message->save();

        return redirect()->route('vendor.message.index');
    }
    ...
    public function view($conversation_id, $user_id)
    {
        ...
        return response()->json([
            'view' => view('vendor-views.messages.partials._conversations',
                compact('convs', 'user', 'receiver', 'sender', 'user_type', 'vendor'))->render(),
        ]);
    }
    ...
    public function store(Request $request, $user_id, $user_type)
    {
        ...
        return response()->json([
            'view' => view('vendor-views.messages.partials._conversations',
                compact('convs', 'user', 'receiver', 'user_type', 'vendor'))->render(),
        ]);
    }
}
