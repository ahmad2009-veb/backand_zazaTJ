...
class ReportController extends Controller
{
    ...
    public function day_wise_report(Request $request)
    {
        ...
        $zone_id       = $request->query('zone_id',
            isset(auth('admin')->user()->zone_id) ? auth('admin')->user()->zone_id : 'all');
        ...
        return view('admin-views.report.day-wise-report',
            compact('zone', 'order_transactions', 'order_transactions_list'));
    }
