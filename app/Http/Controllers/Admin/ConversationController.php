...
class ConversationController extends Controller
{
    ...
    function index()
    {
        $messages = Message::query()->orderBy('created_at', 'ASC')->get();
    ...
    {   
        ...
        $rls                = AdminRole::where('id', $admin->role_id)->first();

        $message                  = new Message();
        $message->sender_id       = $admin->id;
        $message->name            = $admin->f_name.' '.$admin->l_name;
        $message->role            = $rls->name;
    ...
    public function view($conversation_id, $user_id)
    {
        ...
        return response()->json([
            'view' => view('admin-views.messages.partials._conversations',
    ...
    public function store(Request $request, $user_id)
    {
        ...
        $conversation = Conversation::where(['sender_id'   => $receiver->id,
                                             'receiver_id' => 0,
        ])->orWhere(['sender_id' => 0, 'receiver_id' => $receiver->id])->first();
