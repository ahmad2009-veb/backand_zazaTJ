...
class ProvideDMEarningController extends Controller
{
    ...
    public function search_deliveryman_earning(Request $request)
    {
        ...
        $provide_dm_earning = ProvideDMEarning::with('delivery_man')->whereHas('delivery_man',
        ...
        return response()->json([
            'view'  => view('admin-views.deliveryman-earning-provide.partials._table',
                compact('provide_dm_earning'))->render(),
