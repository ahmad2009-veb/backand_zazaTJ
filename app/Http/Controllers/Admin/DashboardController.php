...
class DashboardController extends Controller
{
    ...
    public function dashboard_data()
    {
        ...
        $popular         = Wishlist::with(['restaurant'])
            ...
            ->select('restaurant_id',
                DB::raw('COUNT(restaurant_id) as count'))->groupBy('restaurant_id')->orderBy('count',
                'DESC')->limit(6)->get();
    ...
    public function order_stats_calc($zone_id)
    {
        ...
        if ($params['statistics_type'] == 'today') {
            ...
            $refund_requested = Order::where(['order_status' => 'refund_requested'])->whereDate('refund_requested',
                Carbon::now());
    ...
    public function zone(Request $request)
    {
        ...
        return response()->json([
            ...
            'top_deliveryman'     => view('admin-views.partials._top-deliveryman',
                compact('top_deliveryman'))->render(),
            'top_rated_foods'     => view('admin-views.partials._top-rated-foods',
                compact('top_rated_foods'))->render(),
            'top_restaurants'     => view('admin-views.partials._top-restaurants',
                compact('top_restaurants'))->render(),
            ...
            'monthly_graph'   => view('admin-views.partials._monthly-earning-graph',
                compact('total_sell', 'commission'))->render(),
        ], 200);
    }
